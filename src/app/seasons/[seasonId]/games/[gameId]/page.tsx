...
export default function GameDetailPage({ params }: { params: Promise<{ seasonId: string; gameId: string }> }) {
  ...
  return (
    <main style={{ padding: 30, fontFamily: "sans-serif", maxWidth: 1100 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1>Game {game.game_number} - Attendance</h1>
        <button
          onClick={() => (window.location.href = `/seasons/${seasonId}`)}
          style={{
            color: "#1d4ed8",
      ...
      <section style={{ marginTop: 30 }}>
        <h2>Next Steps</h2>
        <p style={{ color: "#555" }}>Once you've set attendance, you can generate pods and enter results.</p>
      </section>
